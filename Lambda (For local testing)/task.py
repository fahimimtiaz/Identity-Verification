...
if __name__ == "__main__":
    ...
    #     })
    # }
    # result = lambda_handler(test_create_event, None)
    ...
    #     }
    # }
    # result = lambda_handler(test_list_event, None)
    ...
    #     },
    #     "pathParameters": {
    #         "task_id": "c7ae489a-f825-4410-bc5a-c2d9d9351b98"
    #     }
    # }
    # result = lambda_handler(test_details_event, None)
    ...
    test_update_event = {
        ...
        "body": json.dumps({
            "task_id": "09b3c71f-3c89-495d-8a31-df851372bd82",
            # "title": "Task Title New",
            # "priority": "Medium",
            "status": "High"
        })
    }
    result = lambda_handler(test_update_event, None)
    ...
    #     },
    #     "body": json.dumps({
    #         "task_id": "09cc28c6-041c-4895-83ad-1cf02e4fea4a"
    #     })
    # }
    # result = lambda_handler(test_delete_event, None)
